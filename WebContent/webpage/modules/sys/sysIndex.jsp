...
<body class="fixed-sidebar full-height-layout gray-bg">
  ...
  <li><a href=""><i class="fa fa-clone"></i> 
	 <span class="nav-label">推广管理</span><span class="fa arrow"></span></a>
	 <ul class="nav nav-second-level">
		 <li><a class="J_menuItem"  href="/newproject/a/td/act/tdIndeximg" ><i class="fa "></i> <span class="nav-label">推广图片管理</span></a></li>
		 
	 </ul>
 </li>
                  
 <li><a href=""><i class="fa fa-clone"></i> 
	 <span class="nav-label">活动管理</span><span class="fa arrow"></span></a>
	 <ul class="nav nav-second-level">
		
		 <li><a class="J_menuItem"  href="/newproject/a/td/act/tdActivitytype" ><i class="fa "></i> <span class="nav-label">活动栏目管理</span></a></li>
		 <li><a class="J_menuItem"  href="/newproject/a/td/act/tdActivitycontent" ><i class="fa "></i> <span class="nav-label">活动内容管理</span></a></li>
	 </ul>
 </li>
 
  <li><a href=""><i class="fa fa-clone"></i> 
	 <span class="nav-label">项目管理</span><span class="fa arrow"></span></a>
	 <ul class="nav nav-second-level">
		 
		 <li><a class="J_menuItem"  href="/newproject/a/td/pro/tDprojecttype" ><i class="fa "></i> <span class="nav-label">项目栏目管理</span></a></li>
		 <li><a class="J_menuItem"  href="/newproject/a/td/pro/tDprojectcontent" ><i class="fa "></i> <span class="nav-label">项目内容管理</span></a></li>
	 </ul>
 </li>          
