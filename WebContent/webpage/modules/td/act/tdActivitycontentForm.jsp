...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="tdActivitycontent" action="${ctx}/td/act/tdActivitycontent/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   ...
		   <tr>
					...
					<td class="width-35">
						<div class="div-up">
							<c:if test="${not empty tdActivitycontent.pic}">
								<img  id="img9" src="${tdActivitycontent.pic}" height="50" width="80"/>
							</c:if>
							<c:if test="${empty tdActivitycontent.pic}">
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">报名数量：</label></td>
					<td class="width-35">
						<form:input path="number" htmlEscape="false"    class="form-control " onchange="changnumber(this)"/>
					</td>
